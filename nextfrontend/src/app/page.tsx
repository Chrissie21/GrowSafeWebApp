...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-green-100">
      <Head>
        <title>GrowSafe | Secure Your Financial Future</title>
        <meta
          name="description"
          content="GrowSafe - Smart and secure investment options for your financial growth"
        />
      ...
      <header className="container mx-auto px-4 py-6">
        <nav className="flex justify-between items-center">
          <div className="text-green-700 font-bold text-xl">GrowSafe</div>
      ...
      <main className="container mx-auto px-4 pt-20 pb-16">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-5xl font-bold text-green-800 mb-8">GrowSafe</h1>
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Bank-level security protocols to protect your assets at all
                  times.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Diversified portfolios designed for consistent long-term
                  returns.
                </p>
              </div>
      ...
      <footer className="bg-green-800 text-white py-8">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="mt-4">
            <Link href="/terms" className="text-green-200 mx-2 hover:underline">
              Terms
            </Link>
            <Link
              href="/privacy"
              className="text-green-200 mx-2 hover:underline"
            >
              Privacy
            </Link>
            <Link
