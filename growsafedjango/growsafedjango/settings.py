"""
Django settings for growsafedjango project.
...
SECRET_KEY = 'django-insecure-@k#z5v!q2w#e$r^t&y*u(i)o_p+=a-sdfghjklzxcvbnmqwerty'
...
ROOT_URLCONF = 'growsafedjango.urls'
...
WSGI_APPLICATION = 'growsafedjango.wsgi.application'
